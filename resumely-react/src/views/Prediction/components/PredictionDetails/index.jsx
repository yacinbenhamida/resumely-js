...
class PredictionDetails extends Component {
            ...
            <div className={classes.productDetails}>
              <div className={classes.progressWrapper}>
                <Typography
                  ...
                  variant="h6"
                >
                  {name.charAt(0).toUpperCase() + name.slice(1) + ' - ' + countries[name] * 100 + '%'}
                </Typography>
                <LinearProgress
                  value={countries[name] * 100}
                  variant="determinate"
                />
              </div>
            </div>
  ...
  render() {
    ...
    const countrySize = Object.keys(countries).length;
                ...
                >
                  ...
                  <PortletFooter className={classes.portletFooter}>
                    <Button
                      ...
                      variant="text"
                    >
                      Rate Prediction <ArrowRightIcon />
                    </Button>
                  </PortletFooter>
                </Portlet>
              </PortletContent>
